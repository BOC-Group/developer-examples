...
public class StandardRESTfulServicesClientCreateRelation {
	public static void main(final String[] args) throws ClientProtocolException,
		...
		NoSuchProviderException {
			...
			// Replace with the ID of the object you want to update
			final String sObjectID = "3f6e11e4-fb53-408f-b2dd-1dc6c1d68ca2";
			// Replace with the name of the relation class of which you want to create a relation
			final String sRelClassName = "RC_REL_CLASS_NAME";
			...
			final String sPath = "http://HOST:8000/ADOXX/rest/2.0/repos/" +
				sRepoID +
				"/objects/" +
				sObjectID +
				"/relations/outgoing/" +
			...
			final StringBuilder aRelationParams = new StringBuilder();
			aRelationParams.append("{");
			// Replace with the ID of the object you want to create a relation to
			aRelationParams.append("\"toId\":\"{f1cb2932-05dc-44e0-a5dc-fe5d4f6e3795}\"");
			aRelationParams.append("}");
			...
			final StringEntity aJSON = new StringEntity(aRelationParams.toString(),
