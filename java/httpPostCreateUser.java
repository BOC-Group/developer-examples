...
public class StandardRESTfulServicesClientPOSTUser {
	public static void main(final String[] args) throws ClientProtocolException,
		...
		NoSuchProviderException {
			...
			final String sPath = "http://HOST:8080/ADOXX/rest/2.0/users";

			final StringBuilder aUserParams = new StringBuilder();
			aUserParams.append("{");
			aUserParams.append("\"loginName\":\"MyUser\",");
			aUserParams.append("\"password\":\"Password123++\"");
			aUserParams.append("}");
			...
			final StringEntity aJSON = new StringEntity(aUserParams.toString(),
