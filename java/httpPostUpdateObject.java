...
public class StandardRESTfulServicesClientUpdateObject {
	public static void main(final String[] args) throws ClientProtocolException,
		...
		NoSuchProviderException {
			...
			final String sPath = "http://HOST:8080/ADOXX/rest/2.0/repos/" +
				sRepoID +
				"/objects/" +
				sObjectID;
			...
			aUpdateParams.append("\"metaName\":\"A_STRING_ATTR\",");
			aUpdateParams.append("\"value\":\"Updated Value\"");
			aUpdateParams.append("}");
			aUpdateParams.append("]");
			aUpdateParams.append("}");
